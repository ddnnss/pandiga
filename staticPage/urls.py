...
urlpatterns = [
    ...
    path('type/', views.create_city, name='create_city'),
    path('section/', views.create_city, name='create_city'),
    path('subsection/', views.create_city, name='create_city'),
    path('item/', views.create_city, name='create_city'),
    path('user/', views.create_city, name='create_city'),
